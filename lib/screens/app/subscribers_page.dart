...
class _SubscriberFeedbackCard extends StatelessWidget {
  const _SubscriberFeedbackCard({
    required this.icon,
    Color? iconColor,
    @Deprecated('Usa iconColor; se aceptará color temporalmente para mantener compatibilidad.')
    Color? color,
    required this.children,
  })  : assert(iconColor != null || color != null,
            'Debes proporcionar un color para el ícono'),
        assert(iconColor == null || color == null,
            'Define solo iconColor (color es provisional).'),
        iconColor = iconColor ?? color ?? Colors.transparent;
